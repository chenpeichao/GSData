...
//
//
//    public static String get_all_group = "http://open.gsdata.cn/api/wx/wxapi/group_name";//通过UID返回用户分组
//
//    /**
//     * 实时跟踪的接口调用
//     */
...
//            String yesterday = formats.format(new Date().getTime() - 1 * 24 * 60 * 60 * 1000);
//
////            requestParamsMap.put("keyword", "人民日报");
...
//
//            requestParamsMap.put("keyword", "有道");
//            requestParamsMap.put("start", 0);
//            requestParamsMap.put("num", 10);
//
//            //调用接口
